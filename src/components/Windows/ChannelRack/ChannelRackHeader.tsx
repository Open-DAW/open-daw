        ...
        return (
            <div className="channel-rack-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{ width: 100 }} data-tip="Swing" data-effect="solid" data-place="bottom">
                        <Slider onChange={this.setSwing} min={0} max={100} value={this.state.swing} />
                    </div>
                    <div style={{ marginLeft: '10px' }} data-tip="Toggle pattern view" data-effect="solid" data-place="bottom">
